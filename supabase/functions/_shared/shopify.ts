// ============================================================================
// SHOPIFY API CLIENT - Deno Version
// Adaptado do código TypeScript com toda lógica de recorrência
// ============================================================================
...
export async function fetchShopifyData(
  ...
  // Remover .myshopify.com se vier no domain
  ...
  console.log('[Shopify] Starting data fetch...')
  console.log('[Shopify] Domain:', domain)
  console.log('[Shopify] Period:', startLocal, 'to', endLocal)
  ...
  // ========================================================================
  // 5) ANÁLISE DE RECORRÊNCIA (Lógica completa do N8N)
  // ========================================================================
  ...
  // CÁLCULOS FINAIS - Chave canônica e classificação
  ...
  // Classificação de recorrência (LÓGICA IDÊNTICA AO N8N)
  ...
  console.log('[Shopify] Data fetch completed successfully')
  console.log('[Shopify] Orders:', pedidosTotal, '| Fulfilled:', pedidosProcessados)
  console.log('[Shopify] Total sales:', totalVendas.toFixed(2))
  console.log('[Shopify] Returning customers:', clientesRecorrentes, '/', clientesTotalPeriodo)
