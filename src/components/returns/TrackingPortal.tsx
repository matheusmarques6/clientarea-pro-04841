...
const TrackingPortal = () => {
  ...
  return (
    <div className={`min-h-[100svh] sm:min-h-[100dvh] bg-gradient-to-br from-background via-background to-muted/50 px-4 flex ${tracking ? 'flex-col pt-8' : 'items-center justify-center'}`}>
